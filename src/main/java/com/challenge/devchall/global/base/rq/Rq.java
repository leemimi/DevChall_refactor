package com.challenge.devchall.global.base.rq;
...
import com.challenge.devchall.global.standard.util.Ut;
...
public class Rq {
    ...
    public Member getMember() {
        ...
        // 데이터가 없는지 체크
        if ( member == null ) {
            member = memberService.findByLoginID(user.getUsername()).orElseThrow();
        }
        return member;
    }
